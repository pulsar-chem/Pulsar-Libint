...
class LibInt1E : public pulsar::OneElectronIntegral {
protected:
    std::array<libint2::BasisSet,2> bs_;
    libint2::Engine engine_;
public:
     LibInt1E(ID_t id):OneElectronIntegral(id)
     {
        libint2::initialize();
     }
...
using Kinetic=LibInt1E<libint2::Operator::kinetic>;
using Overlap=LibInt1E<libint2::Operator::overlap>;

struct NuclearElectron: public LibInt1E<libint2::Operator::nuclear> {
    using base_type=LibInt1E<libint2::Operator::nuclear>;
